...
New benchmarks done on Llama 2 7B, Llama 3 8B, Mistral and Pythia. Note that there are no results of Pythia for CMMLU and Commonsense-QA because the model performs like random choice due to the formatting of the benchmark. This is present also in the main paper for MMLU and it highlighted in the footnote 10.