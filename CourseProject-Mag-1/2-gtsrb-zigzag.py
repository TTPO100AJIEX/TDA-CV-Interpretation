...
def run_model(
    ...
    *,
    ...
    train_ds = torchvision.datasets.GTSRB('gtsrb', split = 'train', transform = transforms(), download = True)
    test_ds = torchvision.datasets.GTSRB('gtsrb', split = 'test', transform = transforms(), download = True)
    ...
    dumper = zigzag.utils.UniversalDumper(f"zigzag_results/gtsrb/{model_name}")
